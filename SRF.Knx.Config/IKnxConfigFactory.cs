...
/// - <see cref="KnxSystemConfigOptions"/> configured via <see cref="Microsoft.Extensions.Options"/>, e.g. from appsettings.json or other path as per <see cref="Microsoft.Extensions.Configuration"/>.<br/>
