...
public static class ExtensionsKnxAddresses
{
    public class KnxAddressLevelMask(ushort mask, byte shift)
    {
    ...
    public static readonly Dictionary<int,KnxAddressLevelMask> GroupAddressMasks = new()
    {
    ...
    public static readonly Dictionary<int, KnxAddressLevelMask> IndividualAddressMasks = new()
    {
        [1] = new(0b_0000_0000_1111_1111, 0), // level 1
