...
public class DptEncodingTests
{
    ...
    [TestCase(5, 1, 100.0 / 255.0, 50.196, new byte[] { 0x7f }, 1.0/255)] // DPT 5.001 is a scaled numeric with a coefficient of 100/255
    [TestCase(5, 1, 100.0 / 255.0, 100.0, new byte[] { 255 }, 1.0/255)] // DPT 5.001 with a double test value
    [TestCase(1, 1, 1.0, true, new byte[] { 1 }, 0.5)] // DPT 1.001 is a boolean, so the test value of true should be encoded to 1 and decoded back to true
